...
} else {temp_results$inverted_test = 0} # if the coefficient for letter is positive and significant, return a 1, otherwise a 0 for the hired test

temp_results <- cbind(w,temp_results)
